...
sessiondata <-read_excel(path = "I:\\Staff\\GSSW\\SALEM\\DATA ENTRY\\4. PPSC\\PPSC DB 202307.xlsx",
                                   sheet = "session") %>% 
  clean_names()
...
sess_lo <-read_excel(path = "I:\\Staff\\GSSW\\SALEM\\DATA ENTRY\\4. PPSC\\PPSC DB 202307.xlsx",
                                   sheet = "codes_los") %>% 
  clean_names() %>% 
...
registered <- read_excel(path = "I:\\Staff\\GSSW\\SALEM\\DATA ENTRY\\4. PPSC\\PPSC DB 202307.xlsx",
                                   sheet = "registered") %>% 
  clean_names() 
```
...
lo_mean <- sessiondata %>%
  select(cohort, sess_code, pre_lo1:post_lo7) %>% 
