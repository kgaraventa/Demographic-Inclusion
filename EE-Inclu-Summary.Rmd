...
ee_inclusion<-read_excel(path = "I:\\Staff\\GSSW\\SALEM\\DATA ENTRY\\1. EE\\Archive\\2021-2023 Essential Elements DB.xlsx",
  ...
  mutate(cohort = if_else(cohort == "E202210", "2123Q6", cohort)) %>% 
  mutate(cohort = if_else(cohort == "E202211", "2123Q6", cohort)) %>% 
  mutate(cohort = if_else(cohort == "E202212", "2123Q6", cohort))
...
Number of Responses in Quarter: **`r number_trainees_inclusion`**
